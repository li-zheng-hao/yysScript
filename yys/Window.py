...
from yys import YuHunTwoWindow
...
class Window:
    ...
    def initWidgets(self):
        ...
        t1 = tk.Label(frame1, text='护肝脚本', font=("华文行楷", 24), borderwidth=2).pack(side=TOP, fill=X, expand=YES)
        ...
        Button(frame1, command=lambda: YuhunOne(t3),text='御魂副本单刷', width=20).pack(side=TOP, expand=YES)
